    ...
    <div className="min-h-screen sm:p-4 flex flex-col sm:flex-row sm:justify-center sm:items-center sm:w-full sm:gap-x-20 ">
      ...
      <div >
        ...
        <main className="flex-grow flex flex-col justify-center px-7 mt-8">
          <h2 className="text-2xl font-bold mb-4 dark:text-white font-montserrat ">Sign up</h2>
          <p className="mb-6 font-normal text-sm dark:text-white font-lato">Sign up to your account</p>
          ...
          className="space-y-4 bg-[#FFFFFF] rounded-3xl p-4 drop-shadow-md dark:bg-black dark:text-white">
            <div>
              ...
              >
                <p className="font-bold text-base dark:text-white font-lato">Your Name</p>
              </label>
              <input
                type="text"
                id="name"
          ...
          <p className="mt-6 text-center text-sm text-gray-600 font-lato">
            You have an account?{" "}
            <a href="/signin" className="text-indigo-600 hover:text-indigo-500 font-lato">
              Log in
            </a>
          </p>
        </main>
